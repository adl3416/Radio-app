...
export const RADIO_STATIONS: RadioStation[] = [
  ...
  },
  {
    id: 'a-haber',
    name: '📰 A Haber',
    url: 'https://trkvz-radyo.radyotvonline.com/ahaber/ahaber.stream/playlist.m3u8',
    streamUrl: 'https://trkvz-radyo.radyotvonline.com/ahaber/ahaber.stream/playlist.m3u8',
    category: 'news',
  ...
  },
  {
    id: 'trt-turku',
    name: '🪕 TRT Türkü',
    url: 'https://radio-trtturku.live.trt.com.tr/stream',
    streamUrl: 'https://radyotvonline.net/embed2/trtturku.php',
    category: 'folk',
