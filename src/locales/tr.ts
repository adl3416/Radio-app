export default {
  ...
  formatWarning: 'Format Uyarısı',
  formatWarningMessage: 'Bu istasyon API\'den geliyor ve format uyumluluğu garanti edilemez. Sorun yaşarsanız "Yerel" seçeneğine geçin.',
  ...
  changeLanguageConfirm: 'Dili {{newLanguage}} olarak değiştirmek istediğinizden emin misiniz?',
  change: 'Değiştir',
  ...
  emptyRecentDescription: 'Dinlediğiniz radyo istasyonları burada görünecek ve kolayca tekrar erişebilirsiniz.'
};
